...
bool getTemperature() {
  ...
  lcd.setCursor(0, 1);
  lcd.print(String(newValues.temperature)+"C"+"  ");
...
static void getTelemetryPayload(az_span payload, az_span* out_payload)
{
  ...
  payload = az_span_copy( 
    payload, AZ_SPAN_FROM_STR("{\"temp\": "));
    (void)az_span_u32toa(payload,  100 , &payload);
